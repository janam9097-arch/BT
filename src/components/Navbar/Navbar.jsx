        ...
        <div className="hamburger-menu-container" ref={menuRef}>
          ...
          {menuOpen && (
            <div className="hamburger-dropdown-menu">
              {/* Category Quick Links (Mobile view) */}
              <div className="hamburger-menu-section mobile-nav-section">
                <div className="hamburger-menu-header">
                  <span className="hamburger-menu-title">Explore</span>
                </div>
                <ul className="hamburger-menu-list">
                  <li>
                    <Link to="/products" className="hamburger-menu-item" onClick={() => setMenuOpen(false)}>
                      <span>Shop All</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/products?category=men" className="hamburger-menu-item" onClick={() => setMenuOpen(false)}>
                      <span>Men's Collection</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/products?category=women" className="hamburger-menu-item" onClick={() => setMenuOpen(false)}>
                      <span>Women's Collection</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/products?category=kids" className="hamburger-menu-item" onClick={() => setMenuOpen(false)}>
                      <span>Kids Collection</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/categories" className="hamburger-menu-item" onClick={() => setMenuOpen(false)}>
                      <span>Categories</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/products?filter=sale" className="hamburger-menu-item nav-sale-text" onClick={() => setMenuOpen(false)}>
